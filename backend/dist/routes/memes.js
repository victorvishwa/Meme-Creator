...
router.get('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const transformedMeme = Object.assign(Object.assign({}, meme.toObject()), { user: meme.creator, upvotes: meme.votes.upvotes.length, downvotes: meme.votes.downvotes.length, creator: undefined, votes: undefined });
...
router.post('/', auth_1.auth, upload_1.upload.single('image'), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const transformedMeme = Object.assign(Object.assign({}, populatedMeme.toObject()), { user: populatedMeme.creator, upvotes: 0, downvotes: 0, creator: undefined, votes: undefined });
...
router.put('/:id', auth_1.auth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const transformedMeme = Object.assign(Object.assign({}, updatedMeme.toObject()), { user: updatedMeme.creator, upvotes: updatedMeme.votes.upvotes.length, downvotes: updatedMeme.votes.downvotes.length, creator: undefined, votes: undefined });
        res.json(transformedMeme);
    }
    catch (error) {
